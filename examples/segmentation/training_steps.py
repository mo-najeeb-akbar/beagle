...
def create_train_step(num_classes: int):
    """Create JIT-compiled training step.

    Args:
        num_classes: Number of segmentation classes (computed from mask data)
    """
    @jax.jit
...
def create_val_step():
    ...
    def val_step(state: TrainState, batch: dict):
        ...
        # Extract logits from dict output [B, H, W, num_classes]
        pred_logits_full = outputs['logits']
