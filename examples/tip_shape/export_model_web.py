...
def main() -> None:
    ...
    data_iter, batches_per_epoch = create_root_tip_iterator(
        data_dir=data_dir,
        batch_size=1,  # Process one sample at a time
        shuffle=False,  # Keep consistent for comparison
        augment=False,  # No augmentation for validation
        load_stats=True,  # Load existing stats
    )
    ...
    export_path = "monet_segmentation_tf"
    print(f"\n" + "=" * 50)
    ...
    tflite_path = "monet_segmentation.tflite"
